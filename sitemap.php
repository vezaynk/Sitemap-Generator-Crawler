...
- Configure the crawler by editing config.php file. Do not edit this file!
...
{
    global $curl_validate_certificate, $curl_client, $crawler_user_agent;
...
logger("Pretty-printing sitemap", 0);
